...
export default async function PlannerPage() {
  ...
  if (blocksRes.error) throw new Error(`Failed to load planner: ${blocksRes.error.message}`);
  if (dealsRes.error) throw new Error(`Failed to load planner: ${dealsRes.error.message}`);
  if (defaultsRes.error) throw new Error(`Failed to load planner: ${defaultsRes.error.message}`);
  if (placementsRes.error) throw new Error(`Failed to load planner: ${placementsRes.error.message}`);
