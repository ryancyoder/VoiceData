...
// A video's base-level attachment is to the event — deal_id is inherited
// from the event only if the event already has one, and stays null
// otherwise. No file bytes pass through here.
